...
const anonymizationTemplateCode = `from graasp_utils import load_dataset, save_dataset, parse_arguments
...
export default {
  [ALGORITHM_TYPES.ANONYMIZATION]: anonymizationTemplateCode,
  [ALGORITHM_TYPES.VALIDATION]: validationTemplateCode,
};
